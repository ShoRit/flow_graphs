...
class BertRelationClassifier(BertPreTrainedModel):
    ...
    def forward(
        ...
        labels=None,
        device="cpu",  # this should be an instantiation parameter, it will fail if you change
        # device after instantiation.
    ):
        output_dict = {}
        ...
        pooled_output = torch.tanh(pooled_output)  # why tanh?
